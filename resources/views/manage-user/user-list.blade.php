...
<head>
    ...
    <link rel="stylesheet" href={{asset('css/manage-user/user-list/style.css')}}>
    <script src={{asset('js/common/jquery-3.5.1.min.js')}}></script>
    <script src={{asset('js/common/popper.min.js')}}></script>
